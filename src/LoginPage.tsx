...
const LoginPage = function () {
  return (
    <Container className="text-light bg-black">
      <Row>
      ...
      <Row>
        ...
        <Col>
          ...
          <div className="border-bottom border-secondary py-4">
            ...
            <Dropdown>
              ...
              <Dropdown.Menu className="bg-black border border-2 border-light rounded-0">
                {langArray.map((lang) => {
                  return <MenuLang key={lang} value={lang} />
                })}
              </Dropdown.Menu>
            </Dropdown>
          </div>
          ...
          <div className="border-bottom border-secondary py-4">
            ...
            <Button variant="outline-secondary" className="rounded-0 border-2 px-4 my-3 text-light">
              ALL MATURITY RATINGS
            </Button>
            <p>Show titles of all maturity ratings for this profile.</p>
            <Button variant="outline-secondary" className="rounded-0 border-2 px-4 my-1 text-light">
              EDIT
            </Button>
          </div>
